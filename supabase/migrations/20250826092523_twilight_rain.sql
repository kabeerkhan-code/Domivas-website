...
+CREATE INDEX IF NOT EXISTS idx_bookings_appointment_date_uk ON bookings (appointment_date_uk);
 CREATE INDEX IF NOT EXISTS idx_bookings_email ON bookings (email);
 CREATE INDEX IF NOT EXISTS idx_bookings_status ON bookings (status);
-CREATE INDEX IF NOT EXISTS idx_bookings_date_time_uk ON bookings (booking_date, booking_time_uk);
+CREATE INDEX IF NOT EXISTS idx_bookings_appointment_datetime_uk ON bookings (appointment_date_uk, appointment_time_uk);
